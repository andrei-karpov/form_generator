...
Функция КоманднаяПанель(ИмяЭлемента, Родитель = "") Экспорт
	
	ОсновныеПараметры = ОсновныеПараметрыЭлементовФормы(ИмяЭлемента, Родитель);
	ОсновныеПараметры.ТипЭлемента = Тип("ГруппаФормы");
	ОсновныеПараметры.Вид = ВидГруппыФормы.КоманднаяПанель;
	Возврат ОсновныеПараметры;
...
Функция ГруппаКолонок(ИмяЭлемента, Родитель = "") Экспорт
	...
	ОсновныеПараметры.Вставить("Колонки", Новый Массив);
...
Функция ДобавитьЭлементНаФорму(Форма, Параметры) Экспорт
	...
	Если Параметры.Свойство("Колонки") Тогда
		Для Каждого ЭлементКолонки Из Параметры.Колонки Цикл
			Если НЕ ЭлементКолонки.Вид = ВидГруппыФормы.ГруппаКолонок Тогда
				Если Параметры.Вид = ВидГруппыФормы.ГруппаКолонок Тогда
					ЭлементКолонки.ПутьКДанным = Параметры.Родитель + "." + ЭлементКолонки.ПутьКДанным;
				Иначе
